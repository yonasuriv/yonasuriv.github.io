...
# Aliases
 ...
 alias :D="cowsay De que te reis pedazo de forro | lolcat"
 ...
 alias zc="cd;code .zshrc && gtu || cd;codium .zshrc && gtu "
 # Open a website on explorer
 ...
 alias actnow="sudo apt update && sudo apt autoremove && sudo apt full-upgrade"
